...
public class Quaternion {
	...
	public Matrix toMatrix()
	{
		...
		return new Matrix(1.0f-(fTyy+fTzz), fTxy-fTwz, fTxz+fTwy, fTxy+fTwz, 1.0f-(fTxx+fTzz), fTyz-fTwx, fTxz-fTwy, fTyz+fTwx, 1.0f-(fTxx+fTyy));

	}


	//COOLbeans... this is a spherical linear interpolation between two Quaternions
	public static Quaternion slerp(Quaternion a, Quaternion b, float t)
	{
		...
		if ( (1-cosine) < epsilon) return a.scale(1-t).add(b.scale(t*flip)); 
		else
		{
